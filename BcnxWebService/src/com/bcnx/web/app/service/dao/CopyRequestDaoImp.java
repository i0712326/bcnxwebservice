...
public class CopyRequestDaoImp extends DisputeTxnDaoImp {
	...
	// view incoming copy request
	@Transactional
	@Override
	public List<DisputeTxn> getInDisp(final DisputeTxn disp, final int first, final int max) throws SQLException,
			HibernateException {
		return hibernateTemplate.execute(new HibernateCallback<List<DisputeTxn>>(){
			...
			public List<DisputeTxn> doInHibernate(Session session)
				...
				sqlQuery.setString("procc", "500001");
	...
	@Transactional
	@Override
	public List<DisputeTxn> getOutDisp(final DisputeTxn disp, final int first, final int max) throws SQLException,
			HibernateException {
		return hibernateTemplate.execute(new HibernateCallback<List<DisputeTxn>>(){
			@Override
			public List<DisputeTxn> doInHibernate(Session session)
